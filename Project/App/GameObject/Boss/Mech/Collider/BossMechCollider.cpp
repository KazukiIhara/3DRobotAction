...
BossMechCollider::BossMechCollider(BossMech* mech) {
	mech_ = mech;
}

void BossMechCollider::Update() {
	if (!mech_) {
		return;
	}
...
void BossMechCollider::SetCapsule(size_t idx, MechAnimation::TransType a, MechAnimation::TransType b) {
	// 端点ワールド座標
