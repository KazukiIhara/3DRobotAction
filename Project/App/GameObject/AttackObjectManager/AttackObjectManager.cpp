...
void AttackObjectManager::AddMissile(const FriendlyTag& tag, const MissileType& missileType, const Vector3& wPos, float speed, const Vector3& dir, int32_t damage, std::weak_ptr<MechCore> target) {
	// コライダーを作成
	...
	// ミサイルを作成
	Missile newMissile = Missile(missileType, wPos, speed, dir, target, temp);
