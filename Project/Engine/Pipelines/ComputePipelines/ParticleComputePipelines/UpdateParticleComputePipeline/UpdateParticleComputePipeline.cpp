...
void UpdateParticleComputePipeline::CreateRootSignature() {
	...
	rootParams[2].DescriptorTable.NumDescriptorRanges = _countof(freeListIdxUav);
	rootParams[2].DescriptorTable.pDescriptorRanges = freeListIdxUav;
	rootParams[2].ShaderVisibility = D3D12_SHADER_VISIBILITY_ALL;

	// FreeList用
	rootParams[3].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
	rootParams[3].DescriptorTable.NumDescriptorRanges = _countof(freeListUav);
	rootParams[3].DescriptorTable.pDescriptorRanges = freeListUav;
